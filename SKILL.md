...
description: Use this skill to turn multiple repository assessment reports into portfolio-level findings, standards candidates, learning recommendations, remediation priorities, and executive summaries. Trigger whenever the user wants recurring patterns synthesized across several repos, services, code review findings, or diagnostic reports; wants repository findings consolidated into engineering standards, team training, or actionable guidance; or asks what keeps showing up across a portfolio. Use it even if they do not say "cross-repository" or "synthesis" explicitly, as long as the task is to combine completed repo assessments into practical standards, learning plans, or priorities.
---
